(function () {
    ...
    function Passenger(name,lastname,seatNumber, category) {
        this.name = name;
        this.lastname = lastname;
        this.seatNumber = seatNumber || parseInt((90 * Math.random() + 10).toFixed());
        this.category = category || "e";
    ...
    function createPassenger(name,lastname,seatNumber, category) {
        return new Passenger(name,lastname,seatNumber, category);
    };
